...
namespace XStart2._0.Utils {
    ...
    public class LunarCalendar {
        ...
        public LunarCalendar(int year, int month, int day, bool isLeap = false)
            : this(year, month, day, 0, 0, 0, isLeap) {

        }

        public LunarCalendar(int year, int month, int day, int hour, int minute, int second, bool isLeap = false)
            : this(year, month, day, hour, minute, second, 0, isLeap) {

        }

        public LunarCalendar(int year, int month, int day, int hour, int minute, int second, int millisecond, bool isLeap = false) {
            _chineseDateTime = new ChineseLunisolarCalendar();
        ...
        public static LunarCalendar Now => new LunarCalendar(DateTime.Now);
